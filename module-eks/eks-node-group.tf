resource "aws_eks_node_group" "eks_node_group" {
  ...
  # Choose ami_type automatically when module variable is empty.
  # For EKS >= 1.33, Bottlerocket is required/recommended for managed nodegroups.
  ami_type = (
    var.ami_type != "" ? var.ami_type :
    (var.eks_version == "1.33" ? "BOTTLEROCKET_x86_64" : "AL2_x86_64")
  )
